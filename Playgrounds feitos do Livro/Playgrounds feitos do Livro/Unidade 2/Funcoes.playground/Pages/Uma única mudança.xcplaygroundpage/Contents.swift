...
## Uma única mudança
 ...
 Concentrar trabalhos em uma função pode facilitar a sua vida em caso de alterações. Você só precisará mudar o código em um lugar e, como entende o funcionamento e o resultado da função, saberá facilmente qual é esse lugar.
 ...
 */
func rowTheBoat() {
    print("Vai vai, barão, vai vai, barão")
...
verseThree()
/*:
 - callout(Exercício): Agora, a cantiga não será mais sobre balões.\
...
[Anterior](@previous)  |  página 9 de 12  |  [Na sequência: Conclusão](@next)
 */
