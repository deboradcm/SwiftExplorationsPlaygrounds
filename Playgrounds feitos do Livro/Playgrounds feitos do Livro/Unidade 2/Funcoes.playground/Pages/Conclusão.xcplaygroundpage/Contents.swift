...
## Conclusão
 ...
 Você também viu que usar uma função em vez de escrever vários códigos pode facilitar as alterações. Se decidir mudar a forma como um programa funciona, basta alterá-lo em um lugar.
