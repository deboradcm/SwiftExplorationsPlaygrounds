...
//:  - callout(Exercício): Escreva um programa para calcular a circunferência de um círculo com diâmetro igual a 2. Crie uma constante para o diâmetro. A constante precisa ser de que tipo?
