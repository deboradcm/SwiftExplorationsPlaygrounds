...
*/
//: [Next](@next)
let yearOfBirthHusband: String = "1990"
let favoriteFood = "MacarrãO"
var platform: String = "fACEBOOk"
var symbol: String = "@&@"

yearOfBirthHusband + favoriteFood + platform + symbol
print ("Sua senha é:" , yearOfBirthHusband + favoriteFood + platform + symbol)
